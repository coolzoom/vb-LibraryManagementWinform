...
Public Class Form6
    ...
    Private Sub BunifuButton4_Click(sender As Object, e As EventArgs) Handles BunifuButton4.Click
        ...
        Try
            ...
            Query = "select * from anggota where id_anggota ='" & tb_search.DefaultText & "' or nama ='" & tb_search.DefaultText & "' or tahun_ajaran ='" & tb_search.DefaultText & "' or jurusan ='" & tb_search.DefaultText & "' or status ='" & tb_search.DefaultText & "'   "
            Command = New MySqlCommand(Query, MysqlConn)
            Tampil()
    ...
    Private Sub BunifuButton2_Click(sender As Object, e As EventArgs) Handles BunifuButton2.Click
        ...
        Try
            ...
            Else
                ...
                Query = "UPDATE anggota SET id_anggota = '" & tb_id_anggota.Text & "',nama = '" & tb_nama.Text & "',tahun_ajaran = '" & tb_tahun_ajaran.Text & "',jurusan = '" & tb_jurusan.Text & "',status = '" & tb_status.Text & "' where id_anggota ='" & tb_id_anggota.Text & "'  "
                Selected = "select * from anggota"
    ...
    Private Sub bt_hapus_Click(sender As Object, e As EventArgs) Handles bt_hapus.Click
        ...
        Try
            MysqlConn.Open()
            Query = "DELETE from anggota where id_anggota ='" & tb_id_anggota.Text & "' "
            Selected = "select * from anggota"
            Command = New MySqlCommand(Query, MysqlConn)
            Command.ExecuteNonQuery()
    ...
    Private Sub DataGridView1_RowHeaderMouseClick(ByVal sender As Object, ByVal e As DataGridViewCellMouseEventArgs) Handles DataGridView1.RowHeaderMouseClick
        Try
            tb_id_anggota.Text = DataGridView1.SelectedCells(0).Value
            tb_nama.Text = DataGridView1.SelectedCells(1).Value
            tb_tahun_ajaran.Text = DataGridView1.SelectedCells(2).Value
            tb_status.Text = DataGridView1.SelectedCells(4).Value
            tb_jurusan.Text = DataGridView1.SelectedCells(3).Value
